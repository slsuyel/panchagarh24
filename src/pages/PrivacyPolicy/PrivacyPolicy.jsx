...
const PrivacyPolicy = () => {
    return (
        <div className="container my-5">
            <h1 className="text-center ">Privacy Policy for Channeltwenty</h1>
            <p>
                At channeltwenty, accessible from https://www.channeltwenty.com/, one of our
                main priorities is the privacy of our visitors. This Privacy Policy document
                contains types of information that is collected and recorded by
                channeltwenty and how we use it.
            </p>

            <h2>Log Files</h2>
            <p>
                channeltwenty follows a standard procedure of using log files. These files
            ...
            <p>
                Like any other website, channeltwenty uses "cookies". These cookies are used
            ...
            <p>
                ...
                advertising partners of channeltwenty.
            </p>
            <p>
                Third-party ad servers or ad networks uses technologies like cookies,
                JavaScript, or Web Beacons that are used in their respective advertisements
                and links that appear on channeltwenty, which are sent directly to users'
            ...
            <p>
                Note that channeltwenty has no access to or control over these cookies that
                are used by third-party advertisers.
            </p>
            <h2>Third Party Privacy Policies</h2>
            <p>
                channeltwenty's Privacy Policy does not apply to other advertisers or
            ...
            <p>
                channeltwenty does not knowingly collect any Personal Identifiable
            ...
            <p>
                ...
                and/or collect in channeltwenty. This policy is not applicable to any
