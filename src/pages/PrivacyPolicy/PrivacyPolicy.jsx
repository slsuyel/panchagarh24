...
const PrivacyPolicy = () => {
    return (
        <div className="container my-5">
            <h1 className="text-center ">Privacy Policy for panchagarh24.com</h1>
            <p>
                At panchagarh24.com, accessible from https://www.panchagarh24.com/, one of our
                main priorities is the privacy of our visitors. This Privacy Policy document
                contains types of information that is collected and recorded by
                panchagarh24.com and how we use it.
            </p>

            <h2>Log Files</h2>
            <p>
            panchagarh24.com follows a standard procedure of using log files. These files
            ...
            <p>
                Like any other website, panchagarh24.com uses "cookies". These cookies are used
            ...
            <p>
                ...
                advertising partners of panchagarh24.com.
            </p>
            <p>
                Third-party ad servers or ad networks uses technologies like cookies,
                JavaScript, or Web Beacons that are used in their respective advertisements
                and links that appear on panchagarh24.com, which are sent directly to users'
            ...
            <p>
                Note that panchagarh24.com has no access to or control over these cookies that
                are used by third-party advertisers.
            </p>
            <h2>Third Party Privacy Policies</h2>
            <p>
            panchagarh24.com's Privacy Policy does not apply to other advertisers or
            ...
            <p>
            panchagarh24.com does not knowingly collect any Personal Identifiable
            ...
            <p>
                ...
                and/or collect in panchagarh24.com. This policy is not applicable to any
